...
This package is derived from the excellent reveal.js HTML presentation framework[@revealjs] and corresponding R package.[@rstudio-reveal]  [normalize.css](https://github.com/necolas/normalize.css) is a CSS reset distributed with the MIT license.  Fonts are under their respective licenses.
