...
- id: csl-github
  ...
  type: webpage
- id: firefox-footnote
  note: Limited testing shows that Firefox also works, but it doesn't yet apply experimental CSS rules for page size.
---
...
![](../sticker/drposter.png){style="width:60%;"}
</p>
...
### 3rd party
* R logo[@logo]: dual-licensed as CC-BY-SA 4.0 or GPL-2 by The R Foundation (2016)
...
* View and "print as PDF" from Chrome[@firefox-footnote]
